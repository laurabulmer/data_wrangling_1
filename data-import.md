...
Look at ?read_csv for more information. You run this in the console and
...
Read in an excel file. I loaded the readxl library at the top for
neatness sake.
...
what about ‘read.csv’…..? never use this. you should always use
read_csv. we’re trying each below
